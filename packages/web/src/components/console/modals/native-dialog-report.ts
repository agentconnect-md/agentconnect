 ...
 * was never made. The report closes the dialog because one dialog reports ONCE: the model still
 * holds what it proposed and opens a corrected card, which is where a retry belongs — not a form
 * the reader has already submitted once.
 */

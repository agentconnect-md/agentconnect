...
import { executorPrepare, executorRelease, type ExecutorControlDeps } from './executor.js'
...
export const CONTROL_HANDLERS: Map<string, ControlHandler<ControlDeps>> = new Map<string, ControlHandler<ControlDeps>>([
  ...
  ['decision/model-evaluations', decisionModelEvaluations],
  ['decision/model-evaluation', decisionModelEvaluation],
  ...
  ['executor/release', executorRelease],

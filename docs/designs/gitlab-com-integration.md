...
| ------------- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| daemon        | turn-final surface (published), review adapter, turn-start acknowledgement, credential/CLI profile, hook normalization | final poster, formal-review publication steps, the `eyes` reaction on whatever fired the turn (note, else subject), Git credential host rules, read-only CLI shim, session-key recompute and transport-scope pin, maintenance-event handling |

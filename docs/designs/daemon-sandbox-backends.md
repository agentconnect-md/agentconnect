...
runtime and model run (S2c). Still designed: the birth strategy in the session's
verdict and the executor's mismatch refusal (S2b), and the console's strategy picker
(S3).

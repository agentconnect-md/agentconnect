...
| Icon                  | Fixed brand glyph — the native AgentConnect diamond, rendered plateless on every surface (no background, the stored color is inert; not the random default)                                                 |

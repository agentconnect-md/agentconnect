...
| `PATCH /orgs/:orgId/agents/:agentId/installations/:id`  | Same                                                            | Body `{ access?, materialize? }`, at least one present. Access follows the repository rows' monotonic rule; `materialize` may move either way between `decision` and `on-demand` (`decision` is rejected with 400 until the selector lands), and `always` is rejected. A change re-projects the spec and audits; an unchanged body does neither.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |

...
| Package                          | Stack                              | Role                                                                                                                                                                         |
| -------------------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@agentconnect.md/message`       | TypeScript + zod                   | Shared message model and pure Slack/Lark normalization used by daemon and relay; contains no platform SDKs or I/O.                                                           |
